...
.login-container {
    min-height: 100vh;
    display: flex;
    background: url('/eBayanPH/pictures/background_login.png') center/cover no-repeat fixed;
...
.citycebu-image {
    width: 100%;
    height: 400px;
    background: url('/eBayanPH/pictures/cebucity_back.png') center/cover no-repeat;
    border-radius: 16px;
    margin: 2rem 0;
}
.pardo-image{
    width: 100%;
    height: 400px;
    background: url('/eBayanPH/pictures/pardo_image.png') center/cover no-repeat;
    border-radius: 16px;
    margin: 2rem 0;
}
...
.city-image {
    width: 100%;
    height: 500px;
    background: url('/eBayanPH/pictures/home_pic.png') center/cover no-repeat;
    background-size: cover;
    background-position: center;
    border-radius: 16px;
    margin-bottom: 3rem;
